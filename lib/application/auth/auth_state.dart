...
class AuthState {
  ...
  factory AuthState.successSignup(SignupEntity signupEntity) => AuthState(
      isLoading: null, errorMessage: null, signupEntity: signupEntity);
  factory AuthState.countDown(int count,SignupEntity signupEntity) => AuthState(
      isLoading: null,
      errorMessage: null,
      signupEntity: signupEntity,
      countDown: count);

      factory AuthState.successVerifyOtp(VerifyOtpEntity verifyOtpEntity) => AuthState(
      isLoading: null, errorMessage: null, verifyOtpEntity: verifyOtpEntity);
}
